...
``` shell
npm i hexo-generator-json-content --save && npm i --save hexo-wordcount && git clone https://github.com/LingfengZhu/hexo-theme-archer.git themes/archer --depth=1
```
...
- [启用 Mermaid](https://github.com/LingfengZhu/hexo-theme-archer/wiki/%E5%90%AF%E7%94%A8-Mermaid)
